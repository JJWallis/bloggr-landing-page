...
const [header, hamburgerBtn, arrows] = [domSelect('.header'), domSelect('#hamburger'), domSelectAll('.arrow')]
...
header.addEventListener('click', e => {
    ...
    const [navList, arrow, nav] = [target.nextElementSibling, target.firstElementChild, domSelect('#mobile-nav')]
